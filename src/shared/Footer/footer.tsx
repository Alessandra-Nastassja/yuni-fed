...
export default function Footer() {
  ...
  return (
    ...
    >
      <nav className="pointer-events-auto relative w-full max-w-130 rounded-full bg-white shadow-[0_8px_24px_rgba(0,0,0,0.12)] grid grid-cols-4 gap-1 px-3 py-2 items-center">
        <NavLink
          to="/home"
